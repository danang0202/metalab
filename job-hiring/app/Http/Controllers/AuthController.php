...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        try {
            ...
            if($user == null){
                return response()->json([],204); // Email belum terdaftar
            }
            if ($user->email_verified_at == null) {
                return response([
                    'message' => 'Email has not been verified !'
                ],205); // email belum terverifikasi
            }
            ...
            return response(['error' => 'Username and password does not match'], 401);{} // username dan password tidak cocok
        } catch (\Exception $e) {
