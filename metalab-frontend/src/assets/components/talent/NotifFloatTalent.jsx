const NotifFloatTalent = (props) => {
    const status = props.status;
    const text = props.text;
    return (
        <>
            {status == 'fail' ? (
                <div className="from-right bg-clear notif position-fixed" style={{ top: '5rem', right: '0rem', zIndex: '1000' }}>
                ...
                <div className="from-right notif position-fixed bg-clear" style={{ top: '5rem', right: '0rem', zIndex: '1000' }}>
...
export default NotifFloatTalent